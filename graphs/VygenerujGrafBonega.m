...
ylabel('Studená voda [l]','HorizontalAlignment','center','FontSize',13,'FontName','CMU Serif');
ax.YMinorTick = 'on'
ylim([38280 38390]);
...
ylabel('Teplá voda [l]','HorizontalAlignment','center','FontSize',13,'FontName','CMU Serif');
ax.YMinorTick = 'on'
ylim([31520 31860]);
