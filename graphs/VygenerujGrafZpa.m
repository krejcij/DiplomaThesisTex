...
ylabel('Tarif 1 [kWh]','HorizontalAlignment','center','FontSize',13,'FontName','CMU Serif');
ax.YMinorTick = 'on'
ylim([72 95]);
...
ylabel('Tarif 2 [kWh]','HorizontalAlignment','center','FontSize',13,'FontName','CMU Serif');
ax.YMinorTick = 'on'
ylim([115 138]);
