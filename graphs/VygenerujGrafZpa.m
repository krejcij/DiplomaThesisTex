...
% Title
title('Elektromer ZPA ZE.310 (interval 24 hodin)',...
...
hold('on');
yyaxis('left');
pl1 = plot(timestamp,denni,'DisplayName','Tarif 1 (nocní)',...
    'MarkerFaceColor',[0 0.447058826684952 0.74117648601532],...
    'MarkerEdgeColor',[0 0.447058826684952 0.74117648601532],...
    'MarkerSize',4,...
    'Marker','o',...
    'Color',[0 0.447058826684952 0.74117648601532]);
ylabel('Tarif 1 [kWh]','HorizontalAlignment','center','FontSize',12,'FontName','CMU Serif');
ax.YMinorTick = 'on'
ylim([72 95]);

% Axis Y2
yyaxis('right');
pl2 = plot(timestamp,nocni,'DisplayName','Tarif 2 (denni)',...
...
ylabel('Tarif 2 [kWh]','HorizontalAlignment','center','FontSize',12,'FontName','CMU Serif');
ax.YMinorTick = 'on'
ylim([115 138]);
...
export_fig VygenerujGrafZpa.pdf
