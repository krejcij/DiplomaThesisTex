...
%		Vypsané části příkazů pro modul TR-72D-WMB
%		\textcolor[rgb]{0,0,1}{\textbf{Zatím nemá smysl, bude vloženo až do diplomky, v semestrálce se zatím využívají jen dva příkazy.}}

\chapter{Zdrojový kód skriptu pro vyčítání dat}
\label{PrilohaSkript}
\lstinputlisting[language=Python]{codes/sniffer.py}

\chapter{Ukázka výstupu vyčítaných dat}
\label{PrilohaVystup}
