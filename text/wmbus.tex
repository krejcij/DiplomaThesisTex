...
EN 13757-5 & \begin{tabular}[c]{@{}l@{}}Tato část adresy předávání. To zahrnuje celou řadu návrhů na předávání datových \\ rámců jako prostředek k překonání problémů souvisejících se pohybují mezi \\ měřičem a sběru dat bodů.\end{tabular} \\ \hline \hline
\end{tabular}}
\vspace{-10pt}
\end{table}
...
DIF definuje datový typ přenášených dat a má strukturu dle Tab.~\ref{KodovaniDIFu}.
	...
	\hline
	\textbf{Bit 1}                                           & \textbf{Bit2}                                                    & \textbf{Bit 3}                         & \textbf{Bit 4}                        & \textbf{Bit 5} & \textbf{Bit 6} & \textbf{Bit 7} & \textbf{Bit 8} \\ \hline \hline
...
\subsubsection{DIFE}
DIFE obsahují upřesnění, doplňující informaci či přenos chybového stavu dané položky. Jejich kompletní přehled je uveden v Tab.~\ref{KodovaniDIFE}.
...
DIB definuje typ přenášené hodnoty a skládá se z DIF a z nepovinného DIFE.
...
\subsubsection{VIFE}
VIFE obsahují upřesnění, doplňující informaci či přenos chybového stavu dané položky. Jejich kompletní přehled je uveden v Tab.~\ref{KodovaniVIFE}.
