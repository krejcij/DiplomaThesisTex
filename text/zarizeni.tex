...
\textbf{Pole} & \textbf{Popis} & \textbf{Hodnota} \\ \hline \hline
 ...
 \multirow{2}{*}{M-Field} & \multirow{2}{*}{Výrobce zařízení} & B0h   \\ \cline{3-3} 
  &  & 5C \\ \hline 
  \multirow{6}{*}{A-Field} & \multirow{4}{*}{Sériové číslo} & 11h  \\ \cline{3-3} 
  &  & 47h  \\ \cline{3-3}  
  &  & 15h  \\ \cline{3-3} 
 &  & 08h  \\ \cline{2-3} 
...
L-Field            & Délka telegramu                                & 1Eh              \\ \hline
C-Field            & Typ telegramu                                  & 44h              \\ \hline
\multirow{2}{*}{M-Field} & \multirow{2}{*}{Výrobce zařízení}        & 09h              \\ \cline{3-3}
                   &                                                & EEh              \\ \hline
\multirow{6}{*}{A-Field}& \multirow{4}{*}{Sériové číslo}            & 11h              \\ \cline{3-3}
                   &                                                & 47h              \\ \cline{3-3}
                   &                                                & 15h              \\ \cline{3-3}
...
&         & 44h \\ \cline{3-3}
            &         & 37h \\ \cline{3-3}
           &          & 35h \\ \cline{2-3}
            & Verze zařízení        & 11h \\ \cline{2-3}
           & Typ zařízení          & 04h \\ \hline
CI-Field            & Odpověd zařízení   & 72h \\ \hline
Access Number              & Číslo přístupu        & CAh \\ \hline
Status             & Status zařízení       & 10h \\ \hline
\multirow{2}{*}{Configuration Word} & \multirow{2}{*}{Nastavení šifrovaní}  & 50h \\ \cline{3-3}
 &  & 05h \\ \hline
\multirow{2}{*}{AES Encryption}    & \multirow{2}{*}{Kontrola dešifrovaní} & 2Fh \\ \cline{3-3}
     &  & 2Fh \\ \hline
