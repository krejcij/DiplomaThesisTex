...
\vspace{-5pt}
    \centering
			\subfigure[Zapouzdřené čidlo]{\includegraphics[width=0.45\textwidth]{obrazky/zarizeni_weptech1}\label{zarizeni_weptech1}}
			\hspace*{5mm}
			\subfigure[Deska čidla]{\includegraphics[width=0.45\textwidth]{obrazky/zarizeni_weptech2}\label{zarizeni_weptech2}}
