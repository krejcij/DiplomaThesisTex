...
\begin{tabular}{|c|c|c|}
\hline
 & \textbf{Průmyslový IoT} & \textbf{Spotřebitelský IoT} \\ \hline \hline
...
\textbf{Využití} & \begin{tabular}[c]{@{}c@{}}Lepší využívání zdrojů, \\  snížení provozních nákladů, \\ zvýšení efektivity či bezpečnosti.\end{tabular} & \begin{tabular}[c]{@{}c@{}}Zvýšení uživatelského\\ zážitku.\end{tabular} \\ \hline \hline
\end{tabular}
\vspace{-10pt}
  \end{center}
\end{table}
