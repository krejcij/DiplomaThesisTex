...
\end{figure*}
	...
	\begin{figure*}[!ht]
    \centering
			\subfigure[Arduino Fio]{\includegraphics[width=0.45\textwidth]{obrazky/emded_arduino_fio}\label{emded_arduino_fio}}
			\subfigure[Arduino MKR1000]{\includegraphics[width=0.45\textwidth]{obrazky/emded_arduino_mkr1000}\label{emded_arduino_mkr1000}}
