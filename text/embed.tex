...
\begin{figure*}[!ht]
    \centering
			\subfigure[Arduino Duemilanove]{\includegraphics[width=0.3\textwidth]{obrazky/emded_arduino_duemilanove}\label{emded_arduino_duemilanove}}
			\hspace*{5mm}
			\subfigure[Arduino Uno]{\includegraphics[width=0.3\textwidth]{obrazky/emded_arduino_uno}\label{emded_arduino_uno}}
			\hspace*{5mm}
			\subfigure[Arduino Leonardo]{\includegraphics[width=0.3\textwidth]{obrazky/emded_arduino_leonardo}\label{emded_arduino_leonardo}}
...
\begin{figure*}[!ht]
    \centering
			\subfigure[Arduino Mega]{\includegraphics[width=0.45\textwidth]{obrazky/emded_arduino_mega}\label{emded_arduino_mega}}
			\hspace*{5mm}
			\subfigure[Arduino Due]{\includegraphics[width=0.45\textwidth]{obrazky/emded_arduino_due}\label{emded_arduino_due}}
...
\begin{figure*}[!ht]
	\vspace{-10pt}	
    \centering
			\subfigure[Arduino Mini]{\includegraphics[width=0.3\textwidth]{obrazky/emded_arduino_mini}\label{emded_arduino_mini}}
			\hspace*{5mm}
			\subfigure[Arduino Micro]{\includegraphics[width=0.3\textwidth]{obrazky/emded_arduino_micro}\label{emded_arduino_micro}}
			\hspace*{5mm}
			\subfigure[Arduino Nano]{\includegraphics[width=0.3\textwidth]{obrazky/emded_arduino_nano}\label{emded_arduino_nano}}
...
\end{figure*}
	...
	\begin{figure*}[!ht]
    \centering
			\subfigure[Arduino Fio]{\includegraphics[width=0.33\textwidth]{obrazky/emded_arduino_fio}\label{emded_arduino_fio}}
			\hspace*{5mm}
			\subfigure[Arduino MKR1000]{\includegraphics[width=0.33\textwidth]{obrazky/emded_arduino_mkr1000}\label{emded_arduino_mkr1000}}
...
\end{figure*}
	...
	\begin{figure*}[!ht]
    \centering
			\subfigure[Lilypad Arduino ]{\includegraphics[width=0.55\textwidth]{obrazky/emded_arduino_lilipad}\label{emded_arduino_lilipad}}
			\hspace*{5mm}
			\subfigure[Arduino Yun ]{\includegraphics[width=0.35\textwidth]{obrazky/emded_arduino_yun}\label{emded_arduino_yun}}
...
\label{KapArduinoKlony}
	...
	\vspace{-10pt}	
    \centering
			\subfigure[Bare Bones Board]{\includegraphics[width=0.45\textwidth]{obrazky/embed_barebones}\label{emded_barebones}}
			\hspace*{5mm}
			\subfigure[Freaduino]{\includegraphics[width=0.45\textwidth]{obrazky/embed_freaduino}\label{emded_freaduino}}
...
\begin{figure*}[!ht]
    \centering
			\subfigure[Diavolino]{\includegraphics[width=0.45\textwidth]{obrazky/embed_diavolino}\label{emded_diavolino}}
			\hspace*{5mm}
			\subfigure[Boarduino]{\includegraphics[width=0.45\textwidth]{obrazky/embed_boarduino}\label{emded_boarduino}}
...
\begin{figure*}[!ht]
    \centering
			\subfigure[Model A+]{\includegraphics[width=0.3\textwidth]{obrazky/embed_raspi_1a}\label{embed_raspi_1a}}
			\hspace*{5mm}
			\subfigure[Model B]{\includegraphics[width=0.3\textwidth]{obrazky/embed_raspi_1b}\label{embed_raspi_1b}}
			\hspace*{5mm}
			\subfigure[Model B+]{\includegraphics[width=0.3\textwidth]{obrazky/embed_raspi_1bp}\label{embed_raspi_1bp}}
...
\begin{figure*}[!ht]
    \centering
			\subfigure[RaspberryPi 2]{\includegraphics[width=0.3\textwidth]{obrazky/embed_raspi_2}\label{embed_raspi_2}}
			\hspace*{5mm}
			\subfigure[RaspberryPi 3]{\includegraphics[width=0.3\textwidth]{obrazky/embed_raspi_3}\label{embed_raspi_3}}
			\hspace*{5mm}
			\subfigure[RaspberryPi Zero]{\includegraphics[width=0.3\textwidth]{obrazky/embed_raspi_zero}\label{embed_raspi_zero}}
...
%%% ======================================= BANANA PI ============================== %%%
	...
	\vspace{-10pt}
    \centering
			\subfigure[BananaPi BPI-M2]{\includegraphics[width=0.45\textwidth]{obrazky/embed_bananapim2}\label{embed_bananapim2}}
			\hspace*{5mm}
			\subfigure[OrangePi Plus2]{\includegraphics[width=0.45\textwidth]{obrazky/embed_orangepiplus2}\label{embed_orangepiplus2}}
...
\subsection{UpBoard}
	...
	\vspace{-10pt}	
    \centering
			\subfigure[CubieBoard1]{\includegraphics[width=0.45\textwidth]{obrazky/embed_cubie_1}\label{embed_cubie_1}}
			\hspace*{5mm}
			\subfigure[UpBoard1]{\includegraphics[width=0.45\textwidth]{obrazky/embed_upboard}\label{embed_upboard}}
...
ODROID je řada jednodeskových počítačů od společnosti Hardkernel. Název je odvozen z \textbf{O}pen An\textbf{droid}, ale podporovány jsou i linuxové distribuce. Desky disponují 40 pinovým GPIO kompatibilním s RaspberryPi, ale open-source již nejsou. Desky jsou postaveny na SoC platformě Samsung Exynos. Zvláštností desek je sériové rozhraní s 1.8\,V~\cite{HardKernel}.
	...
	\vspace{-10pt}
    \centering
			\subfigure[PINE A64+ 2GB]{\includegraphics[width=0.45\textwidth]{obrazky/embed_pine}\label{embed_pine}}
			\hspace*{5mm}
			\subfigure[HardKernel Odroid-C2]{\includegraphics[width=0.45\textwidth]{obrazky/embed_odroidc2}\label{embed_odroidc2}}
...
\begin{figure*}[!ht]
    \vspace{-20pt}
		\centering
			\subfigure[Arduino board]{\includegraphics[width=0.45\textwidth]{obrazky/embed_intel_edison2}\label{embed_intel_edison2}}
			\hspace*{5mm}
			\subfigure[Intel breakout board]{\includegraphics[width=0.45\textwidth]{obrazky/embed_intel_edison1}\label{embed_intel_edison1}}
