...
%% Klíčová slova
\klicovaslova{Bonega, EN 13757-4, Google Charts, IIoT, IQRF TR-27D-WMB, Kamstrup, Neuron, Python, RaspberryPi, UniPi, Weptech, Wireless M-Bus, ZPA}%
...
%\hypersetup{
%  pdftitle={Implementace komunikačních protokolů pro IoT s využitím rozšiřujícího modulu UniPi pro RaspberryPi},    	% Pole 'Document Title'
%  pdfauthor={PhDr. Jan Krejčí},   	% Pole 'Author'
%  pdfsubject={Diplomová práce}, 						  	% Pole 'Subject'
%  pdfkeywords={Bonega, EN 13757-4, Google Charts, IIoT, IQRF TR-27D-WMB, Kamstrup, Neuron, Python, RaspberryPi, UniPi, Weptech, Wireless M-Bus, ZPA}           	% Pole 'Keywords'
%}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% Vysázení seznamu ukázek zdrojových kódů
\lstlistoflistings
