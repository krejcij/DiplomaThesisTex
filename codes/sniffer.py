...
while True:
    ...
    if readedstring:
        ...
        print time.strftime("%H:%M:%S %d/%m/%Y") + "    Senzor: " + sensor_manu + "." + sensor_type + "." + sensor_sn + "." + sensor_ver + "    Teplota: " + temperature + "C    Vlhkost: " + humidity + "%      RSSI: " + str(signal) + "dBm      Mereni: " + str(increment) + "      " + str(errors) + ""
